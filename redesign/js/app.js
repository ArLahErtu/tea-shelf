...
// ============================================================
import { initDbStatus } from './core/supabase.js';
import { initAuth } from './features/auth.js';
import { initChatbot } from './features/chat.js';
import { initAmountModal } from './features/amount-modal.js';
import { closeOverlay, $$ } from './core/ui.js';
import { FEEDBACK_URL } from './core/config.js';
...
// Само окно и его FAB генерирует features/chat.js; в редизайне FAB скрыт в CSS,
